...
```bash
python skills/synapse-copywriting/scripts/extract-writing-styles.py --list        # List files
python skills/synapse-copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
