...
If the user's message contains a specific technical request (design, code, bug fix, or architecture), you **MUST** pause and invoke the `synapse-memory` skill to retrieve specific project context BEFORE spawning agents. Read `skills/synapse-memory/SKILL.md` for instructions. Do not skip this step.
