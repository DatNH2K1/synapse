---
id: synapse-trend-forecasting
name: synapse-trend-forecasting
module: synapse
phase: anytime
description: "Trend Forecasting & Futurism: Weak Signals, STEEP Analysis, Futures Cone, and Cross-Industry Analogy mapping."
---
...
# Trend Forecasting & Futurism

This skill provides methodologies to identify emerging technological shifts, analyze external megatrends, and extrapolate future market dynamics to design products that are future-proof and visionary.
...
- **T - Technological**: Advances in software, AI, hardware, and networks (e.g., Local LLMs, WebGPU, real-time sync).
- **E - Economic**: Shifting business models, inflation, or gig economy patterns (e.g., Subscription fatigue, micro-transactions).
- **E - Environmental**: Green computing, sustainability requirements (e.g., Energy-efficient code, local processing to save server costs).
- **P - Political**: Regulations, compliance, and geopolitical changes (e.g., Data sovereignty, GDPR/HIPAA compliance, copyright regulations).
...
- **Plausible Future**: What could happen based on current technology developments that are not yet mainstream?
- **Possible Future**: Wild card scenarios, extreme shifts, or black swan events.
- **Preferable Future**: The ideal scenario we want to actively build and steer the product towards.
